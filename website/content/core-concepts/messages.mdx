...
<Callout type="info">
  ...
  compiled, write it with `say`, such as <code>say\`Hello\`</code> or{' '}
  <code>interaction.say\`Hello\`</code>.
</Callout>
...
<Callout type="info">
  Plural categories vary by locale. English uses **one** and **other**, while languages such as
  Arabic use all six categories.
</Callout>
