...
<TypeTable
  type={{
    ...
    transformer: {
      ...
      type: (
        <>
          <a className="text-blue-400" href="#transformer">
            Transformer
          </a>{' '}
          | <a className="text-blue-400" href="#transformer">Transformer</a>[]
        </>
      ),
      required: true,
    },
...
<TypeTable
  type={{
    match: {
      description: 'Function to match file paths.',
    ...
    extract: {
      ...
      type: (
        <>
          (code: string, id: string) {'=>'} <a className="text-blue-400" href="#message">Message</a>[]
        </>
      ),
      required: true,
    },
...
<TypeTable
  type={{
    ...
    parse: {
      ...
      type: (
        <>
          (content: string, context: {'{ locale: string }'}) {'=>'} <a className="text-blue-400" href="#message">Message</a>[]
        </>
      ),
      required: true,
    },
    stringify: {
      ...
      type: (
        <>
          (messages: <a className="text-blue-400" href="#message">Message</a>[], context: {'{ locale: string }'}) {'=>'} string
        </>
      ),
      required: true,
    },
