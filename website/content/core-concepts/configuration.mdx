...
<TypeTable
  type={{
    ...
    transformer: {
      description: 'Transformer for message extraction and transformation.',
      type: (
        <>
...
<TypeTable
  type={{
    ...
    extract: {
      description: 'Function to extract messages from file content.',
      type: (
        <>
    ...
    transform: {
      description: 'Function to transform extracted messages.',
      type: '(id: string, content: string) => string',
      required: true,
    },
  }}
/>
